...
servidor
  ...
  .delete((req,res)=>{
    ...
    if(productos.length<id){
      ...
      //Metodo de los arreglos apra eliminar unio o mas elementos el arreglo iniciando desde una posicion e indicando la cantiad e elementos a eliminar
